...
export const AngularIcon = () => {
    return (
        <svg name="angular-icon" data-testid="geist-icon" height="64" strokeLinejoin="round" viewBox="0 0 16 16" width="64" style={{color: "currentcolor"}}><path d="M8 0L0.5 2.656L1.64393 12.504L8 16L14.3561 12.504L15.5 2.656L8 0Z" fill="#DD0031"></path>
