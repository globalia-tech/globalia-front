...
export const NextIcon = () => {
    return (
        ...
        <svg data-testid="geist-icon" height="64" strokeLinejoin="round" viewBox="0 0 16 16" width="64" style={{color: "currentcolor"}}><g clipPath="url(#clip0_53_108)">
            ...
            <path d="M10.63 11V5" stroke="url(#paint0_linear_53_108r3tj)" strokeWidth="1.25" strokeMiterlimit="1.41421"></path>
            <path fillRule="evenodd" clipRule="evenodd" d="M5.995 5.00087V5H4.745V11H5.995V6.96798L12.3615 14.7076C12.712 14.4793 13.0434 14.2242 13.353 13.9453L5.99527 5.00065L5.995 5.00087Z" fill="url(#paint1_linear_53_108r3tj)"></path>
        </g>
            <defs>
